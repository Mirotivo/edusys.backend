...
public class SubscriptionsAPIController : BaseController
{
    ...
    {
        var userId = GetUserId();
        var details = await _subscriptionService.GetSubscriptionDetails(userId);
    ...
    /// <summary>
    /// Changes the billing frequency (e.g., Monthly to Yearly or vice versa).
    /// </summary>
    [Authorize]
    ...
    {
        var userId = GetUserId();
        var success = await _subscriptionService.ChangeBillingFrequency(userId, request.NewFrequency);
    ...
    {
        var userId = GetUserId();
        var success = await _subscriptionService.CancelSubscription(userId);
