...
public class LandingAPIController : BaseController
{
    ...
    public IActionResult GetJobLocations()
    {
        ...
        {
            new { Img = "assets/img/city/city_sydney.jpg", City = "Sydney", Country = "Australia", Mentors = 14 },
            new { Img = "assets/img/city/city_brisbane.jpg", City = "Brisbane", Country = "Australia", Mentors = 18 },
            new { Img = "assets/img/city/city_perth.webp", City = "Perth", Country = "Australia", Mentors = 22 }
        };
