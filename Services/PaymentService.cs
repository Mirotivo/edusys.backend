...
public class PaymentService : IPaymentService
{
    ...
    public async Task<Transaction> ExecuteTransactionAsync(string stripeCustomerId, string senderId, string? recipientId, decimal amount, PaymentType paymentType, string gatewayName = "Stripe")
    {
        using var transactionScope = await _dbContext.Database.BeginTransactionAsync();
