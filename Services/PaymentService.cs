...
public class PaymentService : IPaymentService
{
        ...
        string gatewayName = "Stripe")
    {
        ...
        if (paymentResult.Status == PaymentResultStatus.Completed)
        {
            ...
            {
                await UpdateWalletBalance(recipientId.Value, netAmount, $"Payment for transaction {transaction.Id}");
            }
        }
        else
        {
    ...
    public async Task<bool> RefundPaymentAsync(int transactionId, decimal refundAmount, decimal retainedAmount, string gatewayName = "Stripe")
    {
        ...
        try
        {
            ...
            {
                var recipientId = transaction.RecipientId.Value;
    ...
    private async Task UpdateWalletBalance(int userId, decimal amount, string reason)
    {
