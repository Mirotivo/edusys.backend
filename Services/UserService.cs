...
public class UserService : IUserService
{
    ...
    public async Task<bool> UpdateUser(string userId, UserDto updatedUser)
    {
        ...
        user.AboutMe = updatedUser.AboutMe?? user.AboutMe;
    ...
    private async Task HandleReferralTokenAsync(string referralToken, string newUserId)
    {
        ...
        await _subscriptionService.CreateSubscription(request, referrer.Id);
    }
    ...
    private int CalculateProfileCompletion(User user)
    {
        ...
        if (!string.IsNullOrEmpty(user.AboutMe)) completedFields++;
