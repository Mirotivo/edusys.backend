...
public class LessonService : ILessonService
{
    ...
    public async Task<LessonDto> ProposeLesson(LessonDto lessonDto, string userId)
    {
        ...
        var chat = _chatService.EnsureChatExists(lessonDto.StudentId, tutorId ?? string.Empty, lessonDto.ListingId);
    ...
    public async Task<List<LessonDto>> GetPropositionsAsync(string contactId, string userId, int listingId)
    {
