...
public class SubscriptionService : ISubscriptionService
{
    ...
    public async Task<SubscriptionDetailsDto?> GetSubscriptionDetails(string userId)
    {
    ...
    /// </summary>
    public async Task<bool> ChangeBillingFrequency(string userId, BillingFrequency newFrequency)
    {
        var subscription = await _dbContext.Subscriptions
