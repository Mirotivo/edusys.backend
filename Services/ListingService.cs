...
public class ListingService : IListingService
{
    ...
    public PagedResult<ListingDto> SearchListings(string query, int page, int pageSize, double? lat = null, double? lng = null, double radiusKm = 10)
    {
    ...
    public ListingStatisticsDto GetListingStatistics()
    {
        ...
        var stats = _dbContext.Listings
            ...
            .Select(g => new ListingStatisticsDto
            {
                ...
                NewListingsToday = g.Count(l => l.CreatedAt.Date == today)
            })
    ...
    {
        var listing = _dbContext.Listings.FirstOrDefault(l => l.Id == id);
        if (listing != null)
        {
