...
public class ChatService : IChatService
{
    ...
    public Chat EnsureChatExists(string studentId, string tutorId, int listingId)
    {
    ...
    {
        var chat = EnsureChatExists(senderId, messageDto.RecipientId ?? string.Empty, messageDto.ListingId);
