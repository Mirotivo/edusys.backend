...
public interface IPaymentService
{
    ...
    Task<Transaction> ExecuteTransactionAsync(string stripeCustomerId, string senderId, string? recipientId, decimal amount, TransactionPaymentType paymentType, string gatewayName = "Stripe");
